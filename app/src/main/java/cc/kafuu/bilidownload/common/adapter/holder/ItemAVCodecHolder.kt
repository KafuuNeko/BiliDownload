...
import cc.kafuu.bilidownload.databinding.ItemAvCodecBinding

class ItemAVCodecHolder(parent: ViewGroup) : CoreRVHolder<ItemAvCodecBinding>(
    ItemAvCodecBinding.inflate(
